...
create_ctx(void)
{
  ...
  double mu_max_ion = 1.5*mi*pow(6.0*vtIon,2)/(2.0*B0);
  ...
  int Nz = 256; // Number of cells in z, originally 8.
  int Nvpar = 256; // Number of cells in vpar.
  int Nmu = 1.5*16; // Number of cells in mu.
