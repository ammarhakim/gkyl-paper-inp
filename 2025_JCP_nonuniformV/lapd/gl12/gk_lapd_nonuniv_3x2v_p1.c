...
struct gk_lapd_ctx {
  ...
  double V_bias; // Biasing voltage (V).
  double r_bias; // Radius of the biased plate (m).
...
void eval_phi_wall_bias(double t, const double *xc, double* GKYL_RESTRICT fout, void *ctx)
{
  double r = xc[0], theta = xc[1], z = xc[2];

  struct gk_lapd_ctx *app = ctx;
  double r_bias = app->r_bias;
  double V_bias = app->V_bias;
...
create_ctx(void)
{
  ...
  // Bias parameters.
  double V_bias = 9.825; // Biasing voltage (V).
...
//    },
    .init_from_file = {
      ...
      .file_name = "../gl0/gk_lapd_nonuniv_3x2v_p1-elc_300.gkyl",
    },
...
//    },
    .init_from_file = {
      .type = GKYL_IC_IMPORT_F,
      .file_name = "../gl0/gk_lapd_nonuniv_3x2v_p1-ion_300.gkyl",
    },
  ...
  struct gkyl_gyrokinetic_field field = {
    ...
    .time_rate_diagnostics = true,
    .phi_wall_lo = eval_phi_wall_bias,
    .phi_wall_up = eval_phi_wall_bias,
    .phi_wall_lo_ctx = &ctx,
    .phi_wall_up_ctx = &ctx,
  };
