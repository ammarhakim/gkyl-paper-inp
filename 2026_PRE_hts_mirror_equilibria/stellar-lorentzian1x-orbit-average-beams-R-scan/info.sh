...
M0mid_R3=$(pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_M0_65.gkyl interp sel --z0 0.0 info 2>&1 | extract_max)
cd ../..
...
M0mid_R5=$(pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_M0_65.gkyl interp sel --z0 0.0 info 2>&1 | extract_max)
cd ../..
...
M0mid_R10=$(pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_M0_65.gkyl interp sel --z0 0.0 info 2>&1 | extract_max)
cd ../..
...
M0mid_R15=$(pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_M0_65.gkyl interp sel --z0 0.0 info 2>&1 | extract_max)
cd ../..
...
M0mid_R22=$(pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_M0_65.gkyl interp sel --z0 0.0 info 2>&1 | extract_max)
cd ../..
...
M0mid_R32=$(pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_M0_65.gkyl interp sel --z0 0.0 info 2>&1 | extract_max)
cd ../stellar-lorentzian1x-orbit-average-beams-R-scan

# Print Python-ready output
echo "# Copy the lines below to Python:"
echo ""
echo "beams_intM0dx_R3 = $M0_R3"
echo "beams_intM0dx_R5 = $M0_R5"
echo "beams_intM0dx_R10 = $M0_R10"
echo "beams_intM0dx_R15 = $M0_R15"
echo "beams_intM0dx_R22 = $M0_R22"
echo "beams_intM0dx_R32 = $M0_R32"
echo "beams_intM0dx_R50 = $M0_R50"
echo ""
echo "beams_intM0Sdx_R3 = $M0S_R3"
echo "beams_intM0Sdx_R5 = $M0S_R5"
echo "beams_intM0Sdx_R10 = $M0S_R10"
echo "beams_intM0Sdx_R15 = $M0S_R15"
echo "beams_intM0Sdx_R22 = $M0S_R22"
echo "beams_intM0Sdx_R32 = $M0S_R32"
echo "beams_intM0Sdx_R50 = $M0S_R50"
echo ""
echo "beams_nu_ii_R3 = $nu_R3"
echo "beams_nu_ii_R5 = $nu_R5"
echo "beams_nu_ii_R10 = $nu_R10"
echo "beams_nu_ii_R15 = $nu_R15"
echo "beams_nu_ii_R22 = $nu_R22"
echo "beams_nu_ii_R32 = $nu_R32"
echo "beams_nu_ii_R50 = $nu_R50"
echo ""
echo "beams_ion_M0mid_R3 = $M0mid_R3"
echo "beams_ion_M0mid_R5 = $M0mid_R5"
echo "beams_ion_M0mid_R10 = $M0mid_R10"
echo "beams_ion_M0mid_R15 = $M0mid_R15"
echo "beams_ion_M0mid_R22 = $M0mid_R22"
echo "beams_ion_M0mid_R32 = $M0mid_R32"
echo "beams_ion_M0mid_R50 = $M0mid_R50"
