...
double gamma0 = 193.893947813; // Beam intM0 = 3.172138e+20
  double T_beam = 200 * GKYL_ELEMENTARY_CHARGE;
double E_beam = 25117.3014755 * GKYL_ELEMENTARY_CHARGE; // Beam intM2 = 7.682495e+32
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_mirror_geo_grid_inp grid_inp = {
    .filename_psi = "/home/mr1884/scratch/gkylmax/generate_efit/lorentzian_R15.geqdsk_psi.gkyl",
