...
FRAME_MAXW_POA = 65  # Maxwellian POA end frame
FRAME_BEAM_POA = 65  # Beam POA end frame
...
# ---------------------------------------------------------------------------
# Color scheme: plasma colormap, two POA curves
# ---------------------------------------------------------------------------
_cmap = plt.cm.inferno
COLORS = [_cmap(0.00), _cmap(0.6)]
# COLORS[0]: Maxwellian POA result
# COLORS[1]: Beam POA result
...
def plot_moments_row(
    ...
    """
    Plot all four moments (density, upar, Tpar, Tperp) across the 2x4 axis
...
def merge_subplot_pairs(ax):
    """
    Scale subplot widths by 1.5x and close the gap between each left/right
...
# ---------------------------------------------------------------------------
# Load moment data for POA end states
# ---------------------------------------------------------------------------
...
ax[0, 3].legend(
    [
        plt.Line2D([], [], color=COLORS[0], linestyle="-", linewidth=solid_linewidth),
        plt.Line2D([], [], color=COLORS[1], linestyle="-", linewidth=solid_linewidth),
    ],
    [
        r"Maxwellian",
        r"Beam",
