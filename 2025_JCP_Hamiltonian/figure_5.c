...
create_ctx(void)
{
  ...
  // Simulation parameters.
  int Ntheta = 192; // Cell count (configuration space: azimuthal angular direction).
  int Nz = 192; // Cell count (configuration space: z direction).
...
main(int argc, char **argv)
{
  ...
  struct gkyl_vm app_inp = {
   .name = "rt_fig4_surf_hyperbolic_khi",
