...
-- ion parameters
vDriftIon = {0.0,0.0}
vtIon = 0.0004      ---- modified from 0.001 (use Te = 50 Ti)
tempRatio = 100.0
-- mass ratio
...
nuee = 0.0004
nuei = 0.0 --nuee              --RLW 
nuii = 1.0e-5  --should have been nuee/math.sqrt(massRatio)*math.pow(tempRatio,1.5)
nuie = 0.0
...
plasmaApp = Plasma.App {
    ...
    tEnd        = 2500,          -- End time. RLW: I changed this, but didn't change nFrame below.  So we might get more frames.
    nFrame      = 250,             -- Number of output frames.  This is 0.5 frames in unit time --> 3 frames every Langmuir period. 
