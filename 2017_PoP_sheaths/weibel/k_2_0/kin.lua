...
phaseDecomp = DecompRegionCalc3D.CartProd { cuts = {8,1,1} }
...
initField = Updater.ProjectOnNodalBasis1D {
   ...
   evaluate = function (x,y,z,t)
      -- no fields initially, just perturbation in Bz
...
function calcMoments(curr, dt, distfElcIn, distfIonIn)
   ...
   -- momentum
   runUpdater(momentumCalcElc, curr, dt, {distfElcIn}, {momentumElc})
   -- energy
