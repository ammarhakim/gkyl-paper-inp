...
create_ctx(void)
{
  ...
  double Vx_drift = 5.0 * cs; // Drift velocity (x-direction).
  ...
  double vx_max_ion = 128.0 * vti; // Domain boundary (ion velocity space: vx-direction).
...
main(int argc, char **argv)
{
  ...
  struct gkyl_pkpm app_inp = {
    .name = "s15_pkpm_es_shock_reflect_p1",
