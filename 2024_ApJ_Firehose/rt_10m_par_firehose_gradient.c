// Parallel-propagating firehose instability, with the gradient closure, for the 10-moment equations.
...
create_ctx(void)
{
  ...
  double k0_ion = 364545.2467783406; // Closure parameter for ions.
