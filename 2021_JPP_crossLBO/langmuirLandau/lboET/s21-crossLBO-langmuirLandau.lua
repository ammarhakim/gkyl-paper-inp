...
nuElc      = 0.005                          -- Electron-electron collision frequency.
nuIon      = nuElc/math.sqrt(mRat)          -- Ion-ion collision frequency.
nuElcIon   = nuElc*math.sqrt(2)/(1.+mRat)   -- Electron-ion collision frequency.
nuIonElc   = (nuElcIon/mRat)/(1.+1./mRat)   -- Ion-electron collision frequency.
