...
local function alpha_E(qs, qr, ms, mr, ns, nr, us, ur, vts, vtr)
...
local function nuG_sr(qs, qr, ms, mr, ns, nr, us, ur, vts, vtr, beta)
   -- LBO-G collision frequency.
   local alphaE = alpha_E(qs, qr, ms, mr, ns, nr, us, ur, vts, vtr)
...
nu_ie = nuG_sr(qi, qe, mi, me, ni, ne, uPari, uPare, vtiIC, vteIC, betaG)
nu_ei = nuG_sr(qe, qi, me, mi, ne, ni, uPare, uPari, vteIC, vtiIC, betaG)
print(' Collision frequencies: ')
print('         nu_ii: ', nu_ii)
print('         nu_ee: ', nu_ee)
print('   LBO-G nu_ie: ', nu_ie)
print('   LBO-G nu_ei: ', nu_ei)
print(' ')
