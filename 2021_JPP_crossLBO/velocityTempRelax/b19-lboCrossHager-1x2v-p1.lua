...
local function nuT_sr(qs, qr, ms, mr, ns, nr, us, ur, vts, vtr)
   ...
   return 2.*((qs*qr)^2)*nr*logLambda/(3.*((2.*math.pi)^(3./2.))*(eps0^2)*ms*mr*((vts^2+vtr^2)^(3./2.)))
end
...
nu_ie = nuT_sr(qi, qe, mi, me, ni, ne, uPari, uPare, vtiIC, vteIC)
nu_ei = nuT_sr(qe, qi, me, mi, ne, ni, uPare, uPari, vteIC, vtiIC)
print(' Collision frequencies: ')
print('          nu_ii: ', nu_ii)
print('          nu_ee: ', nu_ee)
print('   LBO-ET nu_ie: ', nu_ie)
print('   LBO-ET nu_ei: ', nu_ei)
print(' ')
