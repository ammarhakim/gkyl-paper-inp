...
plasmaApp = Plasma.App {
   ...
   nFrame      = 5000,                     -- Number of output frames.
   lower       = {1.26, -Ly/2, -Lz/2}, -- Configuration space lower left.
   upper       = {1.38, Ly/2, Lz/2},   -- Configuration space upper right.
   cells       = {30, 96, 16},              -- Configuration space cells.
   mapc2p = function(xc)
