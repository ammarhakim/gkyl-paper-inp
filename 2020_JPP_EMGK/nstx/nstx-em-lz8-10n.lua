...
sourceDensity = function (t, xn)
   ...
   if x < xSource then
      sourceFloor = 0.5 -- higher floor to left of source peak
   end
...
plasmaApp = Plasma.App {
   ...
   decompCuts = {8, 8, 2}, -- Cuts in each configuration direction.
   ...
   electron = Plasma.GkSpecies {
      ...
      diagnosticMoments = {"GkM0", "GkUpar", "GkTemp", "GkBeta", "GkVtSq"}, 
