...
void
conf_scale(double t, const double *xn, double *fout, void *ctx)
{
    struct gk_asdex_ctx *app = ctx;
    double fac = app->mimp/(39.95*GKYL_PROTON_MASS);
    fout[0] = fac;
}
...
create_ctx(void)
{
  ...
  double mimp = 16.00*GKYL_PROTON_MASS;
  double n0imp = 1e13;
  double Timp0 = 10*eV;
  double cz = 0.68;
