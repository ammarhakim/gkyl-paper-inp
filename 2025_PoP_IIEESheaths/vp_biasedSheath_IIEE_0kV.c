...
struct sheath_ctx {
  ...
  double A2;   // A2-5 are empirical fits for ion stopping power
  double A3;  // Starting at A2 to match source and prevent confusion
  double A4;
  double A5;
...
create_ctx(void)
{
  struct sheath_ctx ctx = {
    ...
    .gauss_E0 = 2.8065640247749997,      // eV
    .gauss_tau = 1.2102115654159102,
    .intWall = 63366509.0954913,
    .A2 = 4.194,
    .A3 = 4.649e3,
    .A4 = 8.113e1,
    .A5 = 2.242e-2,
    .nw = 8.491231742083982e28,
    .Nx = 1024,
    .Nvi = 64,
    .Nve = 512,
...
// Create global range.
  ...
  struct gkyl_bc_emission_ctx *bc_ctx = gkyl_bc_emission_ion_impact_copper_new(ctx.num_emission_species, 0.0, in_species, app_args.use_gpu);
