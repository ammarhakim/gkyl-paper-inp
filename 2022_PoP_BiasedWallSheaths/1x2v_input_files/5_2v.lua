...
local vd_ex, vd_ey = 0.0, 0.0
local vd_ix, vd_iy = 0.0, 0.0
...
sim = Plasma.App {
   ...
   decompCuts = {2*128}, -- cuts in each configuration direction
   ...
   elc = Plasma.Species {
      charge = q_e, mass = m_e,
      -- velocity space grid
      lower = {-6.0*vth_e,-6.0*vth_e},
      upper = {6.0*vth_e,6.0*vth_e},
      cells = {32,32},
      decompCuts = {1,1},
      -- initial conditions
      ...
      bcx = { Plasma.AbsorbBC{},
               Plasma.AbsorbBC{} },
      diagnostics = { "M0", "M1i", "M2ij","M3i","intM0" },
   ...
   ion = Plasma.Species {
      charge = q_i, mass = m_i,
      -- velocity space grid
      lower = {-6.0*vth_i,-6.0*vth_i},
      upper = {6.0*vth_i,6.0*vth_i},
      cells = {64,64},
      decompCuts = {1,1},
      -- initial conditions
      init = Plasma.MaxwellianProjection {
