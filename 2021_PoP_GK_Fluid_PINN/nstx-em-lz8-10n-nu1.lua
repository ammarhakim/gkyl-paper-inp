...
sourceDensity = function (t, xn)
   ...
   return math.max(math.exp(-(x-xSource)^2/(2*lambdaSource)^2), sourceFloor)*math.exp(-z^6/16)
end
...
plasmaApp = Plasma.App {
   ...
   electron = Plasma.Species {
      ...
      diagnosticIntegratedMoments = {"intM0", "intHE"},
      diagnosticBoundaryFluxMoments = {"GkM0", "GkM1", "GkEnergy"},
